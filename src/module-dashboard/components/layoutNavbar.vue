<template>
  <el-menu class="navbar"
    ...
    <div class="right-menu">
      ...
      <div class="item">
        <el-tooltip effect="dark"
          ...
          <el-button icon="el-icon-search"
                     type="text"
                     class="btnSearch"
                     @click="handleBtnSearch"></el-button>
        </el-tooltip>
        <transition name="el-fade-in-linear">
          <el-autocomplete ref="searchInput"
                           v-model="searchVal"
      ...
      <!-- 使用文档 -->
      <a href="http://itheimaadmin.itcast.cn/book/help"
         class="item"
         target="_blank">
        <el-tooltip class="item"
                    effect="dark"
                    content="使用文档"
                    placement="bottom"><i class="el-icon-question"></i></el-tooltip>
      </a>
      <!-- 错误 -->
      ...
      <el-dropdown class="item">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <a target='_blank'
             href="https://github.com/itheima2017/vue-element-admin-itheima">
            <el-dropdown-item>
              {{$t('navbar.github')}}
            </el-dropdown-item>
          </a>
